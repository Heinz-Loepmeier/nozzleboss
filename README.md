...
try starting with this [example.blend file](https://github.com/Heinz-Loepmeier/misc/blob/main/nozzleboss_blend.zip) here, it has a pre-sliced and textured test cube, and all relevant windows opened up.  
